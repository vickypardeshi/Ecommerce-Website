...
import f5 from '../images/footer_img/f5.svg';
        ...
        <div>
            <footer className="footer">
                ...
                <ul className="flex space-btw padding-top">
                    <li><img src={f2} alt="" /> <span>Advertise</span></li>
                    <li><img src={f1} alt="" /> <span>Sell on Flipkart</span></li>
                    <li><img src={f3} alt="" /> <span>Gifts Cards</span></li>
                    <li><img src={f4} alt="" /> <span>Help Center</span></li>
